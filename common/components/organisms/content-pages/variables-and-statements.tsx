  ...
  return (
    <>
      ...
      <Box>
        ...
        {/* image of code */}
        <Paragraph text="What we have done there is created a new variable called first and we set it to a string of heyThere (we will discuss what a string is in a second)." />
